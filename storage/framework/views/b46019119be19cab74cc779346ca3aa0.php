                        ...
                        <div class="rounded-2xl border border-white/5 bg-[#161B29] p-6 shadow-sm transition-all hover:shadow-xl hover:border-white/10">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-lg font-black text-white">#<?php echo e($order->id); ?></p>
                                </div>
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-4 border-t border-white/5 pt-4 md:grid-cols-3">
                                <div class="rounded-xl bg-[#0B0F1A] p-3">
                                    ...
                                    <p class="mt-1 text-xl font-black text-white">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></p>
                                </div>
                                <div class="rounded-xl bg-[#0B0F1A] p-3">
                                    <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500">Metode</p>
                                    <p class="mt-1 text-sm font-bold text-white"><?php echo e($order->payment_method_label); ?></p>
                                </div>
                                <div class="rounded-xl bg-[#0B0F1A] p-3">
                                    <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500">Tanggal</p>
                                    <p class="mt-1 text-sm font-bold text-white"><?php echo e($order->created_at->format('d M Y, H:i')); ?></p>
                                </div>
                            </div>

                            
                            <div class="mt-4 flex flex-wrap gap-3 border-t border-white/5 pt-4">
                                <a href="<?php echo e(route('orders.show', $order)); ?>" class="btn-ghost !text-xs !py-2 !px-4 !rounded-xl !bg-white/5 border border-white/5">

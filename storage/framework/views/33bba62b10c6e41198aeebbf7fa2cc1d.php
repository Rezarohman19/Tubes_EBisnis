    ...
    <div class="py-8 animate-fade-in-up">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest">
                <a href="<?php echo e(route('products.index')); ?>" class="text-slate-500 hover:text-blue-500 transition-colors">KATALOG</a>
                ...
                <div class="space-y-6">
                    <div class="overflow-hidden rounded-3xl border border-white/5 bg-[#161B29] shadow-sm ring-1 ring-white/5">
                        <?php if($product->image): ?>
                            <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="aspect-[4/3] w-full object-cover transition-transform duration-700 hover:scale-105" />
                        <?php else: ?>
                    ...
                    <div class="rounded-2xl border border-white/5 bg-[#161B29] p-8 shadow-sm">
                        <h2 class="text-3xl font-black text-white leading-tight"><?php echo e($product->name); ?></h2>
                        <p class="mt-4 text-sm leading-relaxed text-slate-500"><?php echo e($product->description); ?></p>
                        ...
                        <div class="mt-8 grid grid-cols-2 gap-6">
                            <div class="rounded-2xl bg-[#0B0F1A] border border-white/5 p-6 transition-all hover:border-blue-500/30">
                                ...
                                <p class="text-3xl font-black text-white">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                            </div>
                            <div class="rounded-2xl bg-[#0B0F1A] border border-white/5 p-6 transition-all hover:border-[#10B981]/30">
                                ...
                                <p class="text-3xl font-black text-white"><?php echo e($product->stock); ?> <span class="text-xs font-bold text-slate-500 uppercase ml-1">pcs</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:sticky lg:top-24">
                    <div class="rounded-2xl border border-white/5 bg-[#161B29] p-6 shadow-sm">
                        ...
                        <?php if($product->stock > 0): ?>
                            <?php if(auth()->guard()->check()): ?>
                                <form action="<?php echo e(route('cart.add')); ?>" method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="quantity" value="1" min="1" max="<?php echo e($product->stock); ?>" class="w-full rounded-xl border-white/5 bg-[#0B0F1A] text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 ring-1 ring-white/5 px-4 py-3" />
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between rounded-xl bg-[#0B0F1A] p-4 border border-white/5">
                                        ...
                                        <span class="text-xl font-black text-white">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></span>
                                    </div>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn-primary w-full !py-4 !rounded-xl !text-xs !font-black uppercase tracking-widest">
                        ...
                        <a href="<?php echo e(route('cart.index')); ?>" class="btn-secondary w-full !py-3 !rounded-xl !text-[10px] !font-black uppercase tracking-widest mt-4">LIHAT KERANJANG</a>
                            ...
                            <?php $__currentLoopData = [
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#0B0F1A] border border-white/5">
                                        <svg class="h-4 w-4 <?php echo e($badge['color']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="<?php echo e($badge['icon']); ?>"/></svg>
                                    </div>
                                    <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest"><?php echo e($badge['text']); ?></span>
                                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\asus1\OneDrive\Documents\xampp_terbaru\htdocs\Tubes_EBisnis\resources\views/products/show.blade.php ENDPATH**/ ?>
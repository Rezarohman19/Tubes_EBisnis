            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid gap-6 lg:grid-cols-[2fr_1.1fr]">
                        <div class="space-y-6">
                            <form action="<?php echo e(route('payment.process', $order->id)); ?>" method="POST" class="space-y-6">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="rounded-2xl border border-gray-200 p-6 shadow-sm">
                                    ...
                                    <div class="mt-4 grid grid-cols-2 gap-3">
                                        <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center gap-3 rounded-2xl border p-4 hover:border-green-500 cursor-pointer <?php echo e(old('payment_method', $order->payment_method) === $method ? 'border-green-500 bg-green-50' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="rounded-2xl border border-gray-200 p-6 shadow-sm">
                                    ...
                                    <div class="mt-4 space-y-3 text-sm text-gray-600">
                                        <p><strong>No. Pesanan:</strong> #<?php echo e($order->id); ?></p>
                                        <p><strong>Tanggal:</strong> <?php echo e($order->created_at->format('d F Y, H:i')); ?></p>
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-gray-50 p-6 shadow-sm">
                            ...
                            <div class="mt-4 space-y-4">
                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between gap-4 rounded-2xl bg-white p-4">
                                        ...
                                        <p class="font-semibold text-gray-900">Rp <?php echo e(number_format($item->quantity * $item->price,0,',','.')); ?></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            ...
                            <div class="mt-6 border-t border-gray-200 pt-4">
                                <div class="flex items-center justify-between text-gray-700">
                                    ...
                                    <span class="text-xl font-bold text-gray-900">Rp <?php echo e(number_format($order->total,0,',','.')); ?></span>
                                </div>
                            </div>

        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <?php if(session('info')): ?>
                <div class="mb-6 flex animate-slide-down items-center gap-3 rounded-2xl border border-blue-500/20 bg-blue-500/10 p-4">
                    ...
                    <p class="text-sm font-semibold text-blue-400"><?php echo e(session('info')); ?></p>
                </div>
            <?php endif; ?>
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row">
                        ...
                        <?php if($order->canUploadProof()): ?>
                            <a href="<?php echo e(route('payment.index', $order)); ?>" class="btn-primary flex-1 !py-3 !rounded-xl !text-xs text-center">
                                💳 Bayar / Upload Bukti
                            </a>
                        <?php elseif($order->payment_status !== 'paid' && !$order->isCod() && $order->status !== 'Dibatalkan'): ?>
                            <a href="<?php echo e(route('payment.index', $order)); ?>" class="btn-secondary flex-1 !py-3 !rounded-xl !text-xs text-center">Lihat Info Pembayaran</a>
                        <?php endif; ?>
                    </div>

...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Produk: <?php echo e($product->name); ?> <?php $__env->endSlot(); ?>
                ...
                <form action="<?php echo e(route('admin.products.update', $product)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $product->name)); ?>" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                        </div>

                        <!-- Deskripsi -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Deskripsi</label>
                            <textarea name="description" rows="5" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required><?php echo e(old('description', $product->description)); ?></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="price" value="<?php echo e(old('price', $product->price)); ?>" class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                            </div>
                            
                            <!-- Penyesuaian Stok (Integrated) -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Penyesuaian Stok (Stok Saat Ini: <?php echo e($product->stock); ?>)</label>
                        ...
                        <div>
                            ...
                            <?php if($product->image): ?>
                                <div class="mt-2 relative inline-block">
                                    <img src="<?php echo e(asset('storage/products/' . $product->image)); ?>" class="h-32 w-32 object-cover rounded-xl shadow-sm border border-gray-100">
                                ...
                                <div class="relative flex space-x-3">
                                    <div>
                                        <span class="h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white 
                                            <?php echo e($log->type === 'restock' ? 'bg-green-500' : 'bg-amber-500'); ?>">
                                            <?php if($log->type === 'restock'): ?>
                                        ...
                                        <div>
                                            <p class="text-xs text-gray-500 leading-snug">
                                                ...
                                                <span class="block font-bold text-gray-900 mt-0.5">
                                                    ...
                                                    <span class="font-normal text-gray-400">→ Total: <?php echo e($log->quantity_after); ?></span>
                                                </span>
                                            </p>
                                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\nurai\Tubes_EBisnis\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>
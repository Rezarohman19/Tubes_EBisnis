...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-bold text-blue-600 hover:text-blue-500 transition-colors">Lupa password?</a>
                <?php endif; ?>
            </div>
        ...
        <p class="text-center text-sm font-medium text-gray-600">
            Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="font-bold text-blue-600 hover:text-blue-500 transition-colors">Daftar Gratis →</a>
        </p>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\nurai\Tubes_EBisnis\resources\views/auth/login.blade.php ENDPATH**/ ?>
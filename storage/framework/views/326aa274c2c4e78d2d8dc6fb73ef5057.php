...
<?php endif; ?>
        ...
        <p class="text-center text-sm font-medium text-gray-600">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="font-bold text-blue-600 hover:text-blue-500 transition-colors">Masuk di sini →</a>
        </p>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\nurai\Tubes_EBisnis\resources\views/auth/register.blade.php ENDPATH**/ ?>
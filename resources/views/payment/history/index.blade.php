        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            @if($orders->isEmpty())
                <div class="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-gray-200 bg-gray-50/50 py-16">
                    ...
                    <a href="{{ route('dashboard') }}" class="mt-6 rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-blue-700">
                        Mulai Belanja
                    </a>
                </div>
            @else
                            ...
                            <div class="flex flex-col gap-4 p-6">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    <div>
                                        ...
                                        <p class="mt-1 font-mono text-lg font-bold text-gray-900">#{{ $order->id }}</p>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 border-t border-gray-100 pt-4 md:grid-cols-3">
                                    <div>
                                        ...
                                        <p class="mt-1 text-xl font-bold text-gray-900">Rp {{ number_format($order->total, 0, ',', '.') }}</p>
                                    </div>
                                    <div>
                                ...
                                <div class="flex flex-wrap gap-3 border-t border-gray-100 pt-4">
                                    <a href="{{ route('orders.show', $order) }}" class="inline-flex items-center gap-2 rounded-xl bg-gray-100 px-4 py-2 text-sm font-semibold text-gray-700 transition-all hover:bg-gray-200">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                        </svg>
                                        Detail Pesanan
                                    ...
                                    @if($order->payment_status !== 'paid')
                                        <a href="{{ route('payment.index', $order) }}" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-blue-700">
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                                            </svg>
                                            Bayar Sekarang

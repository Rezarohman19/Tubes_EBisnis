                            ...
                            <form action="{{ route('checkout.place') }}" method="POST" class="space-y-6">
                                ...
                                <div class="rounded-2xl border border-gray-200 p-6 shadow-sm">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <textarea name="shipping_address" rows="4" class="mt-2 w-full rounded-lg border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('shipping_address') }}</textarea>
                                ...
                                <div class="rounded-2xl border border-gray-200 p-6 shadow-sm">
                                    ...
                                    <div class="mt-4 grid grid-cols-2 gap-3">
                                        @foreach($paymentMethods as $method => $label)
                                            <label class="flex items-center gap-3 rounded-2xl border p-4 hover:border-indigo-500 cursor-pointer {{ old('payment_method') === $method ? 'border-indigo-500 bg-indigo-50' : '' }}">
